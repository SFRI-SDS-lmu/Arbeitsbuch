...
plot.vergleich <- function(n,p, byarg) {
  ...
  labs(title = paste("Vergl. Wahrsch.fkt (grau,p=0.5) mit 
...
plot.vergleich(n=1000, p=0.5, byarg=100)
ggsave("loes7_8_1_1000.pdf")
plot.vergleich(n=10000, p=0.5, byarg=1000)
...
plot.vergleich(n=1000, p=0.51, byarg=100)
ggsave("loes7_8_2_1000.pdf")
plot.vergleich(n=10000, p=0.51, byarg=1000)
...
par(cex=1.5)
hist(summe, main="Histogramm", xlab="Summe")
dev.off()

pdf("loes7_8_3_differenz.pdf")
par(cex=1.5)
hist(differenz, main="Histogramm", xlab="Differenz")
dev.off()

pdf("loes7_8_3_produkt.pdf")
par(cex=1.5)
hist(produkt, main="Histogramm", xlab="Produkt")
dev.off()
